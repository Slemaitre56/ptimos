...
public class Sacbleu extends Ptimos implements Magie_commune {
    ...
    void rugir(LesBois bois){
        ...
        */
        ...
        System.out.println(this.nomPtimos +" rugit ! Il semble prendre confiance en lui et pense de plus en plus à évoluer en Cabatrouge !\n");
    ...
    void attaque_degats(){
        ...
        System.out.println(this.nomPtimos +" vient de vous donner un coup de sac remplit de briques ! Vous perdez 5pts de vie !\n");
    }
        ...
        */
        ...
        if(this.pts_Dominance > 32 && this.pts_Dominance < 56){
            if(Math.random() <= 0.1){
               ...
               System.out.println(this.nomPtimos +" s'éloigne en moon walk de " + distance_Ptimos + "!\n"); 
            }
        }
    ...
    public void attaque_mag_commune() {
        ...
        */
        if(this.pts_Dominance > 99 || this.pts_Chance > 60){
            ...
            this.pts_Chance -= 20;
            System.out.println(this.nomPtimos + " utilise sa magie et vous empoisonne avec des particules de plastiques !\n");
        }
